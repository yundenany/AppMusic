package com.example.dk_dn.Activity;
...
//            editor.commit();
//
//            Intent intent = new Intent(RegistionActivity.this, OnBoardingActivity.class);
                        ...
                        db.collection("Users").document(uid).set(userMap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(RegistionActivity.this, "Successfully Register ", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(RegistionActivity.this, MainActivity.class));
                                    }
                                })
